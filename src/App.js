...
function App() {
  ...
  return (
    <div className="App">
      ...
      <GalleryWrapper onReturnUserName={userName} onGetPageValue={getPageValues} onGetPageSecondValue={getPageSecondValues}/>
      {(show) ? <GalleryWrapper2 onReturnPageValue={pageValue} onReturnPageSecondValue={pageSecondValue}/> : false}
